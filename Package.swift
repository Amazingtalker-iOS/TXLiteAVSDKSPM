...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      ...
      url: "https://at-staging-v2.s3.ap-northeast-1.amazonaws.com/yes/TXLiteAVSDK_Live.xcframework.zip",
      checksum: "6a73807872809b5564af972899d37b70bde1557694cccdb8728c5d069156fbba"
    ),
    .binaryTarget(
      name: "TXFFmpeg",
      url: "https://at-staging-v2.s3.ap-northeast-1.amazonaws.com/yes/TXFFmpeg.xcframework.zip",
      checksum: "f7864061c916d686a8244898097f9388fa09ba3a39553d748a1317e944837fcb"
    ),
    .binaryTarget(
      name: "TXLiteAVSDK_ReplayKitExt",
      url: "https://at-staging-v2.s3.ap-northeast-1.amazonaws.com/yes/TXLiteAVSDK_ReplayKitExt.xcframework.zip",
      checksum: "c2346b9b7689c78e9eeae77c0d55509b91c02e7347c0620f261ce77f1d639456"
    ),
    .binaryTarget(
      name: "TXSoundTouch",
      url: "https://at-staging-v2.s3.ap-northeast-1.amazonaws.com/yes/TXSoundTouch.xcframework.zip",
